...
# Input
SOURCES += src/gui/disassemblyview.cpp src/gui/labelsview.cpp src/gui/mainwindow.cpp
HEADERS += src/gui/disassemblyview.hpp src/gui/labelsview.hpp src/gui/mainwindow.hpp
