...
from opcodes import AddressMode as Mode, opcode_table
...
class Instruction:
    _format_operand_table = {
        ...
        Mode.IMPLIED_ACCUMULATOR:               lambda x, s: 'A',
    ...
    def __init__(self, pc, opcode, size, operand=None):
        self.pc = pc
    ...
    def _format_operand(self):
        return self._format_operand_table[self.address_mode](self.operand, self.size - 1)
